...
async function run() {
    ...
    console.log(`[scrape_music_shows] 나무위키에서 확인한 전체 항목: ${rows.length}건`);
    ...
    console.log(`[scrape_music_shows] MUSIC_SHOW_DATA: ${result.mode === "full_resync" ? "전체 재동기화" : "새 항목 " + result.added + "건 추가"} (총 ${result.total}건)`);
}
