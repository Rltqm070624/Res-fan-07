/* ==========================================================================
   ...
   - 앨범 커버 클릭 시 openAlbumModal(index) 호출 (main.js에서 연결)
   ========================================================================== */
...
function renderAlbumGrid() {
    ...
    ALBUMS.forEach(function (album, idx) {
        ahtml += `<div class="profile-item album-cover-item" onclick="openAlbumModal(${idx})"><img src="images/${album.image}" alt="${album.title}" loading="lazy" onerror="this.closest('.profile-item').style.display='none'"></div>`;
    });
